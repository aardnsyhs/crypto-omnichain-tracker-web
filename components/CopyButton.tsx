...
export function CopyButton({ text, label, iconOnly = false, className = '' }: CopyButtonProps) {
  ...
  return (
    <button
      ...
      className={`inline-flex shrink-0 items-center gap-1 rounded px-1.5 py-0.5 font-mono text-[11px] transition-colors focus:outline-none focus:ring-1 focus:ring-zinc-400 ${
        copied
